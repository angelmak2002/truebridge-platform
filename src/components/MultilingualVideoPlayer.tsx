...
const defaultAudioTracks = [
  { label: '粵 ?', lang: 'yue', index: 0 },
  { label: 'English', lang: 'en', index: 1 },
  { label: '? 本 ?, lang: 'ja', index: 2 },
  { label: '? 국??, lang: 'ko', index: 3 },
  { label: '? 通話', lang: 'zh-CN', index: 4 }
];
...
<MultilingualVideoPlayer
  ...
  videoUrl={videos.game_ko}
/>

<MultilingualVideoPlayer
  videoId="game_yue"
  title="粵語版"
  description="Cantonese Female Voice"
  videoUrl={videos.game_yue}
/>

<MultilingualVideoPlayer
  videoId="game_zhCN"
  title="簡體中文版"
  description="Mandarin Female Voice"
  videoUrl={videos.game_zhCN}
/>
        </video>
      </div>
