    ...
    <div className="min-h-screen py-16 px-4" style={{ backgroundColor: "#99FFFF" }}>
      ...
      {showWechatQR && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold text-gray-800 mb-1">加我為 WeChat 好友</h3>
            <p className="text-sm text-gray-500 mb-4">用 WeChat 掃描以下二維碼</p>
            <img
            ...
            <p className="text-xs text-gray-400 mt-3 mb-3">
              WeChat ID：<span className="font-mono text-gray-600 select-all">{wechatId}</span>
            </p>
            <button
